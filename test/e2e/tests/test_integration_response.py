...
def api_resource():
    ...
    api_ref, api_data = helper.api_ref_and_data(api_resource_name=api_resource_name, replacement_values=test_resource_values)
...
class TestIntegrationResponse:
    def test_crud_integration_response(self, api_resource, integration_resource):
        ...
        test_data['INTEGRATION_RESPONSE_KEY'] = "/200/"
        test_data['CONTENT_HANDLING_STRATEGY'] = "CONVERT_TO_TEXT"
        test_data['TEMPLATE_SELECTION_EXPRESSION'] = "$request.body.name"
        ...
        assert aws_res['TemplateSelectionExpression'] == test_data['TEMPLATE_SELECTION_EXPRESSION']
